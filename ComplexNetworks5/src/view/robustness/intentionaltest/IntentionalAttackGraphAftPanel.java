package view.robustness.intentionaltest;
...
public class IntentionalAttackGraphAftPanel extends JPanel{
	...
	public IntentionalAttackGraphAftPanel(ArrayList<Point> locations){
	...
	private void paintNodesName(Graphics g) {
		for(int i =0; i<locations.size()-1; i++){
			if(!GraphUtils.isRemoved(datas, i+1)){
				...
				g.setFont(new Font("»ªÎÄÐÂÎº", Font.BOLD, 10));
