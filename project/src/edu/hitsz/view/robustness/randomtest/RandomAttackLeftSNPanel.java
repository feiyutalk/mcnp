...
public class RandomAttackLeftSNPanel extends JPanel{
	...
	public RandomAttackLeftSNPanel(){
	...
	protected void paintComponent(Graphics g){
		...
		g.drawLine(10, height - BOTTOMWIDTH, width-30, height - BOTTOMWIDTH); //X��
		
		g.drawLine(10, 50, 10, this.HEIGHT-BOTTOMWIDTH); //Y��
